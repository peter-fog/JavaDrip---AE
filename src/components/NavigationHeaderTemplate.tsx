...
const NavigationHeaderTemplate: FC<Props> = ({ children, cartIcon }) => {
    ...
    <header className="relative border-b" role="navigation" aria-label="main-navigation">
      <BaseContainer className="w-full hidden lg:flex lg:flex-row lg:items-center lg:place-content-between lg:py-4">
        <div className="flex justify-between w-full">
          ...
          <div className="flex lg:flex-row flex-col lg:items-center justify-center lg:pl-50 pb-10 lg:pb-0 m-auto">
            {children}
          </div>
      ...
      <div className="w-full lg:hidden flex h-20 flex-row items-center px-5 justify-between ">
        ...
        <div className="flex flex-row justify-between items-center">
          <div className="flex min-w-[40px] mr-5">{cartIcon}</div>
          <button
            type="button"
...
export default NavigationHeaderTemplate;
